...
class CreateExerciseTool extends Tool
{
    ...
    public function handle(Request $request): Response|ResponseFactory
    {
        $validated = $request->validate([
            ...
            'equipment' => 'nullable|string|in:bands,barbell,box,cable,dip station,dumbbell,e-z curl bar,exercise ball,foam roll,kettlebells,machine,medicine ball,other,pull-up bar,rings,sled,suspension trainer,trap bar,weight plate',
    ...
    public function schema(JsonSchema $schema): array
    {
        ...
        return [
            ...
            ])->description('Required equipment. Omit for bodyweight exercises.')->nullable(),
