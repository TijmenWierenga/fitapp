    ...
    >
        <div class="flex flex-col w-full mx-auto space-y-8 text-sm" wire:cloak>
            ...
            <form wire:submit="saveProfile" class="space-y-8">
                ...
                {{-- Goals & Schedule --}}
                <div class="space-y-4">
                    <flux:heading size="sm">{{ __('Goals & Schedule') }}</flux:heading>
                ...
                <div class="space-y-4">
                    <flux:heading size="sm">{{ __('Equipment & Preferences') }}</flux:heading>
                    ...
                    <flux:field>
                        ...
                        <flux:description>{{ __('Select equipment you have at home for home workouts') }}</flux:description>
