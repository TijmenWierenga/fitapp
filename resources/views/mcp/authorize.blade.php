...
<div class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <!-- Card Container -->
        <div class="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-md">
            <!-- Header -->
            <div class="flex flex-col space-y-1.5 p-6">
                <div class="flex items-center justify-center mb-4">
                    <!-- Shield Icon -->
                    <svg class="h-12 w-12 traiq-text-gradient" stroke="currentColor" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="p-6 pt-0 space-y-4">
                <!-- User Info -->
                <div class="rounded-lg border border-zinc-200 dark:border-zinc-800 p-4 bg-zinc-100 dark:bg-zinc-800">
                    <p class="text-sm text-zinc-600 dark:text-zinc-400 mb-2">Logged in as:</p>
                        ...
                        <ul class="space-y-2">
                            @foreach($scopes as $scope)
                                <li class="flex items-start gap-2">
                                    <div class="rounded-full bg-brand-red/10 p-1 mt-0.5">
                                        <div class="h-1.5 w-1.5 rounded-full bg-brand-red"></div>
                                    </div>
            ...
            <div class="flex items-center p-6 pt-0 gap-3">
                ...
                <form method="POST" action="{{ route('passport.authorizations.deny') }}" class="flex-1">
                    ...
                    <flux:button type="submit" variant="ghost" icon="x-mark" class="w-full">
                        Cancel
                    </flux:button>
                </form>
