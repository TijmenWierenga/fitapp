            ...
            <div class="flex items-center justify-between">
                ...
                @if (Route::has('login'))
                    <div class="flex items-center gap-4">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="text-sm text-zinc-400 hover:text-white transition-colors">
                                Dashboard
                            </a>
                        @else
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 rounded-lg text-sm font-medium transition-colors">
                                    Register
                                </a>
                            @endif
                        @endauth
        ...
        <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="{{ route('register') }}" class="px-8 py-4 bg-brand-red hover:bg-red-700 rounded-lg text-lg font-semibold transition-colors inline-flex items-center gap-2">
